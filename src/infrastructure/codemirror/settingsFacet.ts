...
/**
 * Carries plugin settings into editor state. The composition root wraps it
 * in a Compartment and reconfigures on change, so extensions observe
 * updates via `settingsChanged(update)`. No extension holds a reference to
 * the plugin.
 */
